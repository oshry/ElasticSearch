...
class Request {
    ...
    public function __construct(array $parameters = [])
    {
        ...
        $this->parameters['get'] = $this->get = $_GET;
        $this->parameters['post'] = $this->post = $_POST;
    ...
    public function execute()
    {
        ...
        $controller = $class->newInstance($this->parameters);

        // Run the controller's action_*() method
        $response->body($class->getMethod('action_'.$this->action)->invokeArgs($controller, [ $class ]));
